...
@include('demos.header.ab1')
          ...
          <form action="{{ url('/insert') }}" method="POST" role="form" class="php-email-form">
             ...
             <div class="col-md-6 form-group">
                  <input type="password" name="confirm_password" class="form-control" id="password" placeholder="Password Confirmation" required>
              </div>
              </div>
              <div class="text-center"><button type="submit" name="submit">Register Now</button></div>
            </form>
